...
import 'package:community/bloc/bloc_delegate.dart';
...
export 'package:community/vendor/routes.dart';
...
initialiseGlobals() async {
  ...
  graphQLClient = ValueNotifier(GraphQLClient(cache: InMemoryCache(), link: link));
...
Future<Store<AppState>> setupRedux() async {
  ...
  final store = Store<AppState>(appReducer, initialState: initialState, middleware: [
